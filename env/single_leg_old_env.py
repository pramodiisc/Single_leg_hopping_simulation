...
class SingleLegEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        print("current_motor_position",current_motor_position[3])
        ...
        return reward,dev_traj,self.desired_pos,forward_pos, self.power_perstep,new_mot_pos,applied_motor_torque
