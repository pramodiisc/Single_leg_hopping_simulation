...
class HyperParameters():
    ...
    def __init__(self, stairs=False, action_dim=6, normal=True, gait='trot', msg='', nb_steps=10000,
...
class Policy():
    ...
    def evaluate(self, input, delta, direction, hp):
        if direction is None:
            p = self.theta
            for i in range(0,self.output_size): p[i][7:] = 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--env', help='Gym environment name', type=str, default='Stochleg-v0')
    ...
    register(id=args.env,
             entry_point='env.single_leg_env:SingleLegEnv')
    # ---------------------------------------------------------------------------------------------------------------------------------
