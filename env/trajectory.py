...
class TrajectoryGenerator():
    ...
    def update_leg_theta(self, dt):
        ...
        self.theta = constrain_theta(self.theta + self.omega * dt)  #        self.omega = 2 * PI * self.frequency
    ...
    def safety_check(self, x, y, z):
        ...
        if (x**2 + y**2 + z**2) <= (0.8*r)**2:
            # within 80% of max radius, extra factor of safety
            # print("FSP,", x, y, z)
            return [x, y, z]
        else:
            x = (0.8*r) * (x/mag)
    ...
    def generate_trajectory(self, action, prev_motor_angles, dt):
        ...
        for leg in legs:
            ...
            # print(leg.prev_x, leg.prev_y, leg.prev_z, leg.x, leg.y, leg.z)
            ...
            # for X legs configurations BR- < and > for else
            if leg.name == "BR" or leg.name == "BL":
                branch = ">"
            else:
                branch = ">"
            ...
            # for normal legs configurations
            # branch = ">"
...
#                     legs.back_left.motor_abd, legs.back_right.motor_abd]
        leg_motor_angles = [legs.front_left.motor_abd,legs.front_left.motor_hip, legs.front_left.motor_knee, 
                            legs.front_right.motor_abd, legs.front_right.motor_hip, legs.front_right.motor_knee,
                            legs.back_left.motor_abd,legs.back_left.motor_hip, legs.back_left.motor_knee, 
                            legs.back_right.motor_abd,legs.back_right.motor_hip,legs.back_right.motor_knee]
        # print("leg_mot_ang",leg_motor_angles)
